  ...
  return (
    <AboutLayout>
      ...
      <div className="bd-legal-meta">
        <span><strong>설립</strong> · 2026년</span>
        <span><strong>운영</strong> · 서울</span>
      </div>

      <div className="bd-legal-body">
        <h2>우리가 풀려는 문제</h2>
        <p>
          우리나라는 곧 초고령 사회입니다. 부모님 약을 멀리서 챙기고, 병원에서 받아온 검사 결과지를 함께
          해석하고, 오늘 무엇을 드셨는지 같이 고민하는 일 — 그 모든 게 따로따로 흩어져 있습니다. 복약 알림은
          알림 앱, 혈압은 수첩, 검사 결과는 사진, 식단은 머릿속에. 가족과 공유할 길도 없습니다.
        </p>
        <p>
        ...
        <ul>
          ...
          <li><strong>내 손에 맞게</strong> — 식약처 약품 DB, 한국어 OCR, 카카오·네이버 인증. 매일 쓰는 환경에 맞춰 만들어요.</li>
          <li><strong>의료 보조</strong> — Bodacare는 의료 진단·치료를 대체하지 않습니다. 일상의 자가 관리를 돕는 보조 도구입니다.</li>
        </ul>

        <h2>지금까지의 여정</h2>
        <ul>
          <li><strong>2026년 상반기</strong> — 시작. 복약 알림·가족 공유 핵심 기능 구축, iOS·안드로이드 정식 출시 준비.</li>
        ...
        <h2>함께 일하고 싶으신가요</h2>
        <p>
          Bodacare는 작지만 단단한 팀입니다. 디자이너, 엔지니어, 의료 전문가 — 가족 건강의 미래를 같이
